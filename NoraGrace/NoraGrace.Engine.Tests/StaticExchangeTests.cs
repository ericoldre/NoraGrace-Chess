...
namespace Sinobyl.Engine.Tests
{
    ...
    public class StaticExchangeTests
    {
        ...
        public void StaticExchangeTest1()
        {
            ...
            var move = MoveUtil.Create(Position.E4, Position.D5, board.PieceAt(Position.E4), board.PieceAt(Position.D5));
        ...
        public void StaticExchangeTest2()
        {
            ...
            int moveSee = see.CalculateScore(board, MoveUtil.Create(Position.E4, Position.D5, board.PieceAt(Position.E4), board.PieceAt(Position.D5)));
