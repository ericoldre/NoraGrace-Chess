...
namespace Sinobyl.Engine.Tests
{
    ...
    public class EvalTest
    {
        ...
        public void PawnTest1()
        {
            ...
            var result = pawnEval.EvalAllPawns(board[ChessPiece.WPawn], board[ChessPiece.BPawn], board.ZobristPawn);
        ...
        public void EvalTest1()
        {
            ...
            while (!reader.EndOfStream)
            {
                ...
                foreach (ChessMove move in pgn.Moves)
                {
                    ...
                    eval.EvalLazy(board, e1, null);
                    eval.EvalLazy(boardRev, e2, null);
